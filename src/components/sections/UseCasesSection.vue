<template>
  <section id="use-cases" class="py-16 md:py-20">
    <div class="container mx-auto px-4">
      <SectionTitle center>
        <template #title>Кому нужен Support360</template>
        <template #subtitle>Решения для различных сфер бизнеса — от IT-поддержки до гостиничного сервиса</template>
      </SectionTitle>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 ml-10 mr-10">
        ...
        >
          ...
          >
            <UseCaseCard :title="useCase.title">
              <template #icon>
                <component :is="useCase.icon" class="w-12 h-12" />
              </template>
            </UseCaseCard>
          </div>
          ...
          >
            <div class="p-4">
              ...
              <ul class="space-y-1">
                <li 
                  v-for="(feature, i) in useCase.example.features" 
                  :key="i" 
          ...
          <div class="bg-gray-50 rounded-xl overflow-hidden shadow-md ml-10 mr-10 relative">            
            <div class="grid grid-cols-1 md:grid-cols-2">
              <div class="p-8 md:p-12">
                ...
                <ul class="space-y-3">
                  <li 
                    v-for="(feature, index) in selectedCase.example.features" 
                    :key="index" 
                    class="flex items-start"
                  >
