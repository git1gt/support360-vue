<template>
  ...
  >
    ...
    <div class="absolute inset-0 overflow-hidden">
      <div 
        v-if="!isMobile"
        class="absolute -top-10 -right-10 w-64 h-64 rounded-full bg-primary/30 blur-3xl parallax-element"
        data-speed="30"
      ></div>
      <div 
        v-if="!isMobile"
        class="absolute top-1/3 -left-24 w-48 h-48 rounded-full bg-primary/20 blur-3xl parallax-element"
        data-speed="20"
      ></div>
      <div 
        v-if="!isMobile"
        class="absolute bottom-1/4 right-1/4 w-56 h-56 rounded-full bg-primary/20 blur-3xl parallax-element"
        data-speed="40"
      ></div>
    </div>
          ...
          <div class="parallax-element" data-speed="-15">
            ...
            >
              <div class="flex items-center">
                <CheckCircle2Icon class="w-5 h-5 md:w-6 md:h-6 text-green-500 mr-2" />
                <div>
...
const ArrowDownIcon = {
  render: () => h('svg', {
    ...
    h('line', { x1: '19', y1: '12', x2: '12', y2: '19' }),
    h('line', { x1: '5', y1: '12', x2: '12', y2: '19' })
  ])
}
